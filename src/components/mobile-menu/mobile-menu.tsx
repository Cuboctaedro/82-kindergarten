...
export const MobileMenu = ({
    ...
    return (
        <Popover className="relative">
            <PopoverButton className="relative z-20">Menu</PopoverButton>
                ...
                <nav>
                    <ul className="p-6">
                        <li>
                            <Link
                                href="/"
                                className="whitespace-nowrap text-black hover:text-white flex items-center justify-start gap-4 h-16"
                            >
                        ...
                        <li>
                            <Disclosure>
                                <DisclosureButton className="whitespace-nowrap text-black hover:text-white flex items-center justify-start gap-4 h-16">
                                ...
                                >
                                    {pagesSubmenu.items.map((item) => (
                                        <Link key={item.title} href={item.url} className="whitespace-nowrap py-1 block text-black hover:text-white"
                                        >
                                            {item.title}
                                        </Link>
                                    ))}
